import svgPaths from "./svg-l51vpp8zjh";
...
function Heading() {
  return (
    <div className="content-stretch flex gap-[16px] h-[35.998px] items-center relative shrink-0 w-full" data-name="Heading 1">
      ...
      <p className="css-g0mm18 flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[36px] min-h-px min-w-px not-italic overflow-hidden relative text-[#101828] text-[30px] text-ellipsis tracking-[0.3955px]">NDA Bank</p>
    </div>
  );
}
...
function Button() {
  return (
    <div className="bg-[#434343] content-stretch flex items-center justify-center px-[8px] py-[6px] relative rounded-[14px] shrink-0" data-name="Button">
      <p className="css-ew64yg font-['Inter:Medium',sans-serif] font-medium leading-[24px] not-italic relative shrink-0 text-[16px] text-center text-white tracking-[-0.3125px]">Retainer</p>
    </div>
  );
}
...
function Heading2() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Heading 3">
      <p className="css-g0mm18 flex-[1_0_0] font-['Inter:Medium',sans-serif] font-medium leading-[27px] min-h-px min-w-px not-italic overflow-hidden relative text-[#101828] text-[18px] text-ellipsis tracking-[-0.4395px]">Salary</p>
    </div>
  );
}
...
function Container3() {
  return (
    <div className="h-[39.991px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute css-ew64yg font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[40px] left-0 not-italic text-[#00a63e] text-[36px] top-[0.33px] tracking-[0.3691px]">€3,500</p>
    </div>
  );
}
...
function Container4() {
  return (
    <div className="h-[39.991px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute css-ew64yg font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[40px] left-0 not-italic text-[#0f0e0e] text-[36px] top-[0.33px] tracking-[0.3691px]">€38500</p>
    </div>
  );
}
...
function App() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px pb-[16px] pt-0 px-0 relative w-full" data-name="App">
      <StatusBarIPhone />
      <Frame2 />
      <Container2 />
      <Container5 />
...
function Frame1() {
  return (
    <div className="content-stretch flex flex-col h-full items-start relative shrink-0 w-[440px]">
      <App />
      <HomeIndicator />
    </div>
  );
...
export default function ClientRetainerSettings() {
  return (
    <div className="bg-[#f0f0f0] content-stretch flex items-start overflow-clip relative rounded-[44px] size-full" data-name="Client — retainer — settings">
      <Frame1 />
    </div>
  );
}