import svgPaths from "./svg-xkgblqjg6e";
...
function Materials() {
  return (
    <div className="absolute inset-0 overflow-clip" data-name="Materials">
...
function Grabber() {
  return (
    <div className="absolute h-[5px] left-[calc(50%-1px)] top-[6px] translate-x-[-50%] w-[36px]" data-name="Grabber">
      <div className="absolute inset-0 rounded-[2.5px]" data-name="Resize Indicator">
        <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-[2.5px]">
          <div className="absolute bg-[rgba(127,127,127,0.4)] inset-0 mix-blend-luminosity rounded-[2.5px]" />
          <div className="absolute bg-[rgba(61,61,61,0.5)] inset-0 mix-blend-overlay rounded-[2.5px]" />
        </div>
      </div>
    </div>
  );
...
function CloseButton() {
  return (
    <div className="content-stretch flex items-center justify-center relative rounded-[1000px] shrink-0 size-[30px]" data-name="Close Button">
      <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-[1000px]">
        <div className="absolute bg-[rgba(127,127,127,0.2)] inset-0 mix-blend-luminosity rounded-[1000px]" />
        <div className="absolute bg-[rgba(61,61,61,0.5)] inset-0 mix-blend-overlay rounded-[1000px]" />
      </div>
      <div className="flex flex-[1_0_0] flex-col font-['SF_Pro:Semibold',sans-serif] font-[590] h-full justify-center leading-[0] min-h-px min-w-px relative text-[#3d3d3d] text-[16px] text-center" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="css-4hzbpn leading-[21px]">􀅾</p>
      </div>
    </div>
  );
}
...
function TitleAndControls() {
  return (
    <div className="absolute content-stretch flex items-center justify-between left-0 pb-[12px] pt-0 px-[16px] right-0 top-[14px]" data-name="Title and Controls">
      <p className="css-4hzbpn font-['SF_Pro:Semibold',sans-serif] font-[590] leading-[25px] relative shrink-0 text-[20px] text-black text-center tracking-[-0.45px] w-[54.415px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        Title
      </p>
      <CloseButton />
    </div>
...
function SheetIPhone() {
  return (
    <div className="h-[423px] overflow-clip relative rounded-tl-[10px] rounded-tr-[10px] shadow-[0px_0px_100px_0px_rgba(0,0,0,0.05)] shrink-0 w-[440px]" data-name="Sheet - iPhone">
      <Materials />
      <Grabber />
      <TitleAndControls />
    </div>
...
function ClientProjectsSettings1() {
  return (
    <div className="absolute bg-[rgba(0,0,0,0.5)] content-stretch flex h-[956px] items-end left-0 overflow-clip rounded-[44px] top-0" data-name="Client — projects — settings">
      <SheetIPhone />
    </div>
  );
}

export default function ClientProjectsSettings() {
  return (
    <div className="bg-[#f0f0f0] content-stretch flex gap-[10px] items-start overflow-clip relative rounded-[44px] size-full" data-name="Client — projects — settings">
      <Frame2 />
      <ClientProjectsSettings1 />
    </div>
  );
}