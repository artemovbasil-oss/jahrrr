...
export function EditProjectScreen({ projectId, onNavigate }: EditProjectScreenProps) {
  const { projects, clients, getClient, updateProject } = useCRM();
  ...
  const [formData, setFormData] = useState({
    ...
    status: (project?.status || 'in progress') as Project['status'],
